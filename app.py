# ---------- app.py (Full KHT AI Auto-Grader with 5 Pages, Styled & Functional) ----------
...
# ---------- Page 2: Upload & Grade Student Exam ----------
elif page=="📤 Upload & Grade Student Exam":
    ...
    if exam_file:
        ...
        if st.button("Grade Answer"):
            if not model_answer: st.markdown("<p class='notification'>⚠️ Answer key missing.</p>", unsafe_allow_html=True)
...
# ---------- Page 3: Search Results ----------
elif page=="🔍 Search Results (ID or Name)":
    ...
    else: st.markdown("<p class='notification'>No results found. Upload student exams first.</p>", unsafe_allow_html=True)
...
# ---------- Page 5: Analytics ----------
    ...
    if os.path.exists(analytics_path):
        ...
        if df.empty: st.markdown("<p style='color:#000000; font-weight:bold;'>⚠️ No student results yet.</p>", unsafe_allow_html=True)
        else:
        ...
        st.markdown("<p class='notification'>No results to analyze yet. Upload exams first.</p>", unsafe_allow_html=True)
