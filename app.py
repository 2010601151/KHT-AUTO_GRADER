...
if login_type == "Teacher":
    ...
    if register_btn:
        if teacher_user in teachers:
            ...
            st.sidebar.markdown("<p class='notification'>✅ Teacher registered. Await admin approval.</p>", unsafe_allow_html=True)
        else:
...
if st.session_state.role == "Admin":
    ...
    if admin_page == "All Teacher Results":
        ...
        if result_files:
            ...
            st.dataframe(all_results.style.applymap(color_rows, subset=["Score"]))
        else:
            st.info("No results available yet.")

# ---------- Teacher / Common Pages ----------
else:
